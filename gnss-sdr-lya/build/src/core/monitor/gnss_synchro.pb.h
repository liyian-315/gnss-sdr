...
class GnssSynchro final :
 ...
 public:
  ...
  void clear_flag_cycle_slip();
  bool flag_cycle_slip() const;
  void set_flag_cycle_slip(bool value);
  private:
  bool _internal_flag_cycle_slip() const;
  void _internal_set_flag_cycle_slip(bool value);
  public:
...
// bool flag_cycle_slip = 27;
inline void GnssSynchro::clear_flag_cycle_slip() {
  _impl_.flag_cycle_slip_ = false;
}
inline bool GnssSynchro::_internal_flag_cycle_slip() const {
  return _impl_.flag_cycle_slip_;
}
inline bool GnssSynchro::flag_cycle_slip() const {
  // @@protoc_insertion_point(field_get:gnss_sdr.GnssSynchro.flag_cycle_slip)
  return _internal_flag_cycle_slip();
}
inline void GnssSynchro::_internal_set_flag_cycle_slip(bool value) {
  
  _impl_.flag_cycle_slip_ = value;
}
inline void GnssSynchro::set_flag_cycle_slip(bool value) {
  _internal_set_flag_cycle_slip(value);
  // @@protoc_insertion_point(field_set:gnss_sdr.GnssSynchro.flag_cycle_slip)
}
