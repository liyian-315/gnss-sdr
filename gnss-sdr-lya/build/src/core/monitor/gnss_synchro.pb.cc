...
PROTOBUF_CONSTEXPR GnssSynchro::GnssSynchro(
  ...
  , /*decltype(_impl_.flag_cycle_slip_)*/false
...
const uint32_t TableStruct_gnss_5fsynchro_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::gnss_sdr::GnssSynchro, _impl_.flag_cycle_slip_),
  ~0u,  // no _has_bits_
...
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 33, -1, -1, sizeof(::gnss_sdr::Observables)},
};
...
const char descriptor_table_protodef_gnss_5fsynchro_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\022gnss_synchro.proto\022\010gnss_sdr\"\257\005\n\013GnssS"
  ...
  "se_locked\030\032 \001(\010\022\027\n\017flag_cycle_slip\030\033 \001(\010"
  "\"8\n\013Observables\022)\n\nobservable\030\001 \003(\0132\025.gn"
  "ss_sdr.GnssSynchrob\006proto3"
  ;
...
const ::_pbi::DescriptorTable descriptor_table_gnss_5fsynchro_2eproto = {
    false, false, 786, descriptor_table_protodef_gnss_5fsynchro_2eproto,
    "gnss_synchro.proto",
...
GnssSynchro::GnssSynchro(const GnssSynchro& from)
  ...
  new (&_impl_) Impl_{
    ...
    , decltype(_impl_.flag_cycle_slip_){}
    , /*decltype(_impl_._cached_size_)*/{}};
  ...
  ::memcpy(&_impl_.prn_, &from._impl_.prn_,
    static_cast<size_t>(reinterpret_cast<char*>(&_impl_.flag_cycle_slip_) -
    reinterpret_cast<char*>(&_impl_.prn_)) + sizeof(_impl_.flag_cycle_slip_));
...
// @@protoc_insertion_point(message_clear_start:gnss_sdr.GnssSynchro)
  ...
  ::memset(&_impl_.prn_, 0, static_cast<size_t>(
      reinterpret_cast<char*>(&_impl_.flag_cycle_slip_) -
      reinterpret_cast<char*>(&_impl_.prn_)) + sizeof(_impl_.flag_cycle_slip_));
    ...
    switch (tag >> 3) {
      ...
      case 26:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 208)) {
          ...
          goto handle_unusual;
        continue;
      // bool flag_cycle_slip = 27;
      case 27:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 216)) {
          _impl_.flag_cycle_slip_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
uint8_t* GnssSynchro::_InternalSerialize(
  ...
  // bool flag_cycle_slip = 27;
  if (this->_internal_flag_cycle_slip() != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteBoolToArray(27, this->_internal_flag_cycle_slip(), target);
  }
...
void GnssSynchro::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  if (from._internal_flag_cycle_slip() != 0) {
    _this->_internal_set_flag_cycle_slip(from._internal_flag_cycle_slip());
  }
...
void GnssSynchro::InternalSwap(GnssSynchro* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(GnssSynchro, _impl_.flag_cycle_slip_)
      + sizeof(GnssSynchro::_impl_.flag_cycle_slip_)
