...
| 19 | `19_y790s_8ch_uca_space_delay_plan.md` | **Y790s 阵列空间-时延计划(v1.1:4 物理阵元双馈,8-UCA 降为理论参考,见 §13)**：方向模型、路线P(MUSIC对照)/路线R(主算法)、可辨识性、Gate 0–6、数据规范、厂家接口清单、证据等级纪律 | 开展 Y790s 采购/多通道开发/阵列实验前必读 | 🟡 v1 冻结+v1.1 修订 |
