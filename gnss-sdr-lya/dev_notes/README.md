...
| 26 | `26_四阵元线阵真实GNSS波形与FBSS仿真报告.md` | **四阵元 ULA 北斗 B2a 波形实验台**：B2a data/pilot 码、同源功分/线缆模型、C/N0 换算、直接 MUSIC 与 FBSS、复相关时延、公平 DOA 基准及球面波/有限距离边界 | 制作 ULA 样机或讨论手机 C/N0 与阵列可分离性前必读 | 🟡 公平远场 DOA 基准 30/30；有限距离流形待解决 |
