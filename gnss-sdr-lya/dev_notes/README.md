...
| 26 | `26_四阵元线阵真实GNSS波形与FBSS仿真报告.md` | **四阵元 ULA 真实 GPS 波形实验台**：L1 C/A Gold 码、同源功分/线缆模型、C/N0 换算、直接 MUSIC 与 FBSS、测角后时延、固定点/相位/CN0/随机圆域结果 | 制作 ULA 样机或讨论手机 C/N0 与阵列可分离性前必读 | 🟡 仿真完成；实测流形待补 |
