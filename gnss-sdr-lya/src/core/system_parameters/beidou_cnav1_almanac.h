/*!
 * \file beidou_cnav1_almanac.h
 * \brief  Interface of a beidou cnav1 ALMANAC storage
...
#ifndef GNSS_SDR_BEIDOU_CNAV1_ALMANAC_H_
#define GNSS_SDR_BEIDOU_CNAV1_ALMANAC_H_

#include <boost/serialization/nvp.hpp>

/*!
 * \brief This class is a storage for the beidou SV ALMANAC data as described BEIDOU B1C ICD
 * \note Code added as part of GSoC 2019 program
 */
class Beidou_Cnav1_Almanac
{
public:
