/*
 * \file beidou_cnav1_utc_model.cc
...
double Beidou_Cnav1_Utc_Model::time_of_transmission(Beidou_Cnav1_Almanac const&alm, Beidou_Cnav1_Ephemeris const&eph, double t_sv)
{
...
double Beidou_Cnav1_Utc_Model::beidt_to_utc(Beidou_Cnav1_Ephemeris const&eph, double time_bds)
{
	double t_UTC;
	double dt_UTC;
	double W;
...
double Beidou_Cnav1_Utc_Model::beidt_to_gpst(Beidou_Cnav1_Ephemeris const&eph, double beidou_time)
{
	double t_GNSS;
