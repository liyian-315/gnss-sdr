/*!
 * \file beidou_cnav1_almanac.cc
 * \brief  Interface of a Beidou CNAV1 ALMANAC storage as described in Beidou B1C ICD
...
Beidou_Cnav1_Almanac::Beidou_Cnav1_Almanac()
{
...
double Beidou_Cnav1_Almanac::BDS_time_of_transmission(double t_sv)
{
	double t;
	double dt_sv;
