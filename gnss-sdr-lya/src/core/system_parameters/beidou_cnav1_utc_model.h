 ...
 * \brief  Interface of a BEIDOU CNAV1 UTC MODEL storage
...
#ifndef GNSS_SDR_BEIDOU_CNAV1_UTC_MODEL_H_
#define GNSS_SDR_BEIDOU_CNAV1_UTC_MODEL_H_
...
//!!! Check
/*!
 * \brief This class is a storage for the BEIDOU CNAV1 UTC MODEL data as described in BEIDOU B1C ICD
 */
...
public:
    ...
    /*!
     * \brief Serialize is a boost standard method to be called by the boost XML serialization. Here is used to save the UTC data on disk file.
     */
    ...
    double time_of_transmission(Beidou_Cnav1_Almanac const&alm, Beidou_Cnav1_Ephemeris const&eph, double t_sv);

    double beidt_to_gpst(Beidou_Cnav1_Ephemeris const&eph, double beidou_time);

    /*!
     * \brief Converts from BEIDOUT to GPST
     */
    double beidt_to_utc(Beidou_Cnav1_Ephemeris const&eph, double time_bds);
