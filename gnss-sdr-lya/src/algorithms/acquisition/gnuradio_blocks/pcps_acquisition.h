...
private:
    ...
    struct AcquisitionResult
    {
        ...
        // Second-path (multipath) detection — populated when d_acq_parameters.multipath_detection
        bool has_second_peak{false};
        uint32_t index_time2{0};      // 2nd-peak code phase [samples]
    ...
    void find_second_peak(AcquisitionResult& result);
    void wait_if_active();
