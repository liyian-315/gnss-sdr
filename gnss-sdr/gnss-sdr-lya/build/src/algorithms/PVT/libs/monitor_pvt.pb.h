...
class MonitorPvt final :
 ...
 public:
  ...
  ~MonitorPvt() override;
  explicit PROTOBUF_CONSTEXPR MonitorPvt(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  MonitorPvt* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  void MergeFrom( const MonitorPvt& from) {
    MonitorPvt::MergeImpl(*this, from);
  }
  private:
  ...
  void clear_week();
  uint32_t week() const;
  void set_week(uint32_t value);
  private:
  uint32_t _internal_week() const;
  void _internal_set_week(uint32_t value);
  public:
  ...
  uint32_t valid_sats() const;
  void set_valid_sats(uint32_t value);
  private:
  uint32_t _internal_valid_sats() const;
  void _internal_set_valid_sats(uint32_t value);
  public:
  ...
  uint32_t solution_type() const;
  void set_solution_type(uint32_t value);
  private:
  uint32_t _internal_solution_type() const;
  void _internal_set_solution_type(uint32_t value);
  public:
  ...
  uint32_t galhas_status() const;
  void set_galhas_status(uint32_t value);
  private:
  uint32_t _internal_galhas_status() const;
  void _internal_set_galhas_status(uint32_t value);
  public:
 ...
 private:
  ...
  struct Impl_ {
    ...
    double longitude_;
    double height_;
    uint32_t valid_sats_;
    uint32_t solution_status_;
    uint32_t solution_type_;
...
inline uint32_t MonitorPvt::_internal_tow_at_current_symbol_ms() const {
  return _impl_.tow_at_current_symbol_ms_;
}
inline uint32_t MonitorPvt::tow_at_current_symbol_ms() const {
  // @@protoc_insertion_point(field_get:gnss_sdr.MonitorPvt.tow_at_current_symbol_ms)
  return _internal_tow_at_current_symbol_ms();
}
inline void MonitorPvt::_internal_set_tow_at_current_symbol_ms(uint32_t value) {
  
  _impl_.tow_at_current_symbol_ms_ = value;
}
inline void MonitorPvt::set_tow_at_current_symbol_ms(uint32_t value) {
...
inline uint32_t MonitorPvt::_internal_week() const {
  return _impl_.week_;
}
inline uint32_t MonitorPvt::week() const {
  // @@protoc_insertion_point(field_get:gnss_sdr.MonitorPvt.week)
  return _internal_week();
}
inline void MonitorPvt::_internal_set_week(uint32_t value) {
  
  _impl_.week_ = value;
}
inline void MonitorPvt::set_week(uint32_t value) {
...
inline void MonitorPvt::clear_valid_sats() {
  _impl_.valid_sats_ = 0u;
}
inline uint32_t MonitorPvt::_internal_valid_sats() const {
  return _impl_.valid_sats_;
}
inline uint32_t MonitorPvt::valid_sats() const {
  // @@protoc_insertion_point(field_get:gnss_sdr.MonitorPvt.valid_sats)
  return _internal_valid_sats();
}
inline void MonitorPvt::_internal_set_valid_sats(uint32_t value) {
  
  _impl_.valid_sats_ = value;
}
inline void MonitorPvt::set_valid_sats(uint32_t value) {
...
inline uint32_t MonitorPvt::_internal_solution_status() const {
  return _impl_.solution_status_;
}
inline uint32_t MonitorPvt::solution_status() const {
  // @@protoc_insertion_point(field_get:gnss_sdr.MonitorPvt.solution_status)
  return _internal_solution_status();
}
inline void MonitorPvt::_internal_set_solution_status(uint32_t value) {
  
  _impl_.solution_status_ = value;
}
inline void MonitorPvt::set_solution_status(uint32_t value) {
...
inline void MonitorPvt::clear_solution_type() {
  _impl_.solution_type_ = 0u;
}
inline uint32_t MonitorPvt::_internal_solution_type() const {
  return _impl_.solution_type_;
}
inline uint32_t MonitorPvt::solution_type() const {
  // @@protoc_insertion_point(field_get:gnss_sdr.MonitorPvt.solution_type)
  return _internal_solution_type();
}
inline void MonitorPvt::_internal_set_solution_type(uint32_t value) {
  
  _impl_.solution_type_ = value;
}
inline void MonitorPvt::set_solution_type(uint32_t value) {
...
inline void MonitorPvt::clear_ar_ratio_factor() {
  _impl_.ar_ratio_factor_ = 0;
}
inline float MonitorPvt::_internal_ar_ratio_factor() const {
  return _impl_.ar_ratio_factor_;
}
...
inline void MonitorPvt::clear_ar_ratio_threshold() {
  _impl_.ar_ratio_threshold_ = 0;
}
inline float MonitorPvt::_internal_ar_ratio_threshold() const {
  return _impl_.ar_ratio_threshold_;
}
...
inline void MonitorPvt::_internal_set_ar_ratio_threshold(float value) {
  ...
  _impl_.ar_ratio_threshold_ = value;
}
...
inline void MonitorPvt::clear_user_clk_drift_ppm() {
  _impl_.user_clk_drift_ppm_ = 0;
}
inline double MonitorPvt::_internal_user_clk_drift_ppm() const {
  return _impl_.user_clk_drift_ppm_;
}
...
inline void MonitorPvt::_internal_set_user_clk_drift_ppm(double value) {
  ...
  _impl_.user_clk_drift_ppm_ = value;
}
...
void MonitorPvt::set_utc_time(ArgT0&& arg0, ArgT... args) {
...
inline void MonitorPvt::clear_galhas_status() {
  _impl_.galhas_status_ = 0u;
}
inline uint32_t MonitorPvt::_internal_galhas_status() const {
  return _impl_.galhas_status_;
}
inline uint32_t MonitorPvt::galhas_status() const {
  // @@protoc_insertion_point(field_get:gnss_sdr.MonitorPvt.galhas_status)
  return _internal_galhas_status();
}
inline void MonitorPvt::_internal_set_galhas_status(uint32_t value) {
  
  _impl_.galhas_status_ = value;
}
inline void MonitorPvt::set_galhas_status(uint32_t value) {
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void MonitorPvt::set_geohash(ArgT0&& arg0, ArgT... args) {
 
 _impl_.geohash_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void MonitorPvt::set_allocated_geohash(std::string* geohash) {
  ...
  _impl_.geohash_.SetAllocated(geohash, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.geohash_.IsDefault()) {
