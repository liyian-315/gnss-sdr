...
public:
    ...
    bool multipath_detection{false};  // detect & report a 2nd correlation peak (multipath / 2nd path)
    bool acquire_second_path{false};  // Stage 1b: hand the 2nd peak (not the main) to tracking, so this channel tracks the reflection
